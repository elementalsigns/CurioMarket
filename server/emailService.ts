...
Thank you for being part of the Curio Market community!`;
  ...
  async sendBuyerMessageNotification(data: { buyerEmail: string; buyerName: string; shopName: string; messagePreview: string }): Promise<boolean> {
    const subject = `New Message from ${data.shopName}`;
    
    const text = `New Message from ${data.shopName}

Dear ${data.buyerName},

You have a new message waiting in your dashboard from ${data.shopName}.

Message Preview:
"${data.messagePreview}"

Please log into your dashboard to view and respond to this message: https://curiosities.market/messages

Thank you for shopping at Curio Market!`;
    ...
    const html = `
      ...
      <body>
        <div class="container">
          ...
          <p>You have a new message waiting in your dashboard from <strong>${data.shopName}</strong>.</p>
          ...
          <div style="text-align: center;">
            <a href="https://curiosities.market/messages" class="action-button">View Messages</a>
          </div>
          
          <p>The seller may have updates about your order or answers to your questions.</p>
          
          <div class="footer">
            <p>Thank you for shopping at Curio Market</p>
          </div>
        </div>
      </body>
      </html>
