...
export default function NotFound() {
  ...
  if (typeof window !== 'undefined') {
    ...
    if (path === '/' || path === '/seller/guide' || path === '/safety' || path === '/contact' || path === '/privacy' || path === '/terms' || path === '/prohibited' || path === '/browse' || path === '/account' || path.startsWith('/seller/') || path.startsWith('/orders/') || path.startsWith('/favorites') || path.startsWith('/cart') || path.startsWith('/checkout')) {
      return null;
    }
  }
