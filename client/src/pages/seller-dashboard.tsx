    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="analytics" className="space-y-6" data-testid="dashboard-tabs">
          ...
          {/* Listings Tab */}
          <TabsContent value="listings" className="space-y-4 pb-16 sm:pb-0 pt-16" data-testid="content-listings">
          ...
          {/* Inventory Tab */}
          <TabsContent value="inventory" className="space-y-4 pb-16 sm:pb-0 pt-16" data-testid="content-inventory">
            <div className="flex items-center justify-between">
          ...
          {/* Orders Tab */}
          <TabsContent value="orders" className="space-y-4 pb-16 sm:pb-0 pt-16" data-testid="content-orders">
            <div className="flex items-center justify-between">
          ...
          <TabsContent value="earnings" className="space-y-4 pb-16 sm:pb-0 pt-16" data-testid="content-earnings">
            <div className="flex items-center justify-between">
          ...
          {/* Reviews Tab */}
          <TabsContent value="reviews" className="space-y-4 pb-16 sm:pb-0 pt-16" data-testid="content-reviews">
            <div className="flex items-center justify-between">
          ...
          {/* Messages Tab */}
          <TabsContent value="messages" className="space-y-4 pb-16 sm:pb-0 pt-16" data-testid="content-messages">
            <div className="flex items-center justify-between">
          ...
          {/* Promotions Tab */}
          <TabsContent value="promotions" className="space-y-4 pb-16 sm:pb-0 pt-16" data-testid="content-promotions">
            <div className="flex items-center justify-between">
          ...
          {/* Profile Tab */}
          <TabsContent value="profile" className="space-y-4 pb-16 sm:pb-0 pt-16" data-testid="content-profile">
