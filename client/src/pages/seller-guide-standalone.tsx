    ...
    <div>
      <style>{`
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .footer { background: #0a0a0a; border-top: 3px solid rgba(255, 255, 255, 0.4); padding: 4rem 1rem; margin-top: 4rem; flex-shrink: 0; }
        ...
        .footer-bottom { border-top: 2px solid rgba(255, 255, 255, 0.3); padding-top: 2rem; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem; }
